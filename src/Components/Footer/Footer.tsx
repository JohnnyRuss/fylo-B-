...
const Footer: React.FC<FooterType> = (props) => {
  return (
    <Container
      fluid
      as="footer"
      className="bg-app-dark-blue text-app-light-gray py-app-8"
    >
      <Container>
        ...
        <Row className="mt-app-3">
          <Col lg={3} className="d-flex flex-column align-items-center align-items-lg-start">
            <Figure className="d-flex align-items-center gap-3">
              <Figure.Image src="/assets/icon-phone.svg" />
              <Figure.Caption>Phone: +1-543-123-4567</Figure.Caption>
            </Figure>
            <Figure className="d-flex align-items-center gap-3">
              <Figure.Image src="/assets/icon-email.svg" />
              <Figure.Caption>example@fylo.com</Figure.Caption>
            </Figure>
          </Col>
          <Col lg={3}>
            <ul className="list-style-none text-capitalize d-flex flex-column align-items-center align-items-lg-start gap-2">
              {["about us", "jobs", "press", "blog"].map((item) => (
                <li className="cursor-pointer  blue-hover" key={item}>
                  {item}
                </li>
              ))}
            </ul>
          ...
          <Col lg={3} className="d-flex gap-4 align-items-start justify-content-center justify-content-lg-start">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
